...
<body class="animated fadeInDown" id="login">
...
<header id="header">
    ...
    <span id="extr-page-header-space"> <span class="hidden-mobile hidden-xs">Já tem conta?</span> <a href="{{ route('login') }}" class="btn btn-danger">Logar</a> </span>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-offset-3">
                <div class="well no-padding">
                    ...
                    {!! Form::open(['route' => 'authUser.store', 'method' => 'post', 'class' => 'smart-form client-form', 'id' => 'smart-form-register']) !!}
                        <header>
                            Jogo gratuito, registre-se agora!
                        </header>
                        ...
                        <fieldset>
                            ...
                            <section>
                                <label class="input"> <i class="icon-append fa fa-user"></i>
                                    {!! Form::text('login',null,['required','placeholder' => 'Login', 'required']) !!}
                                    <b class="tooltip tooltip-bottom-right">Escreva seu login para jogar.</b> </label>
                            </section>

                            <section>
                                <label class="input"> <i class="icon-append fa fa-envelope"></i>
                                    {!! Form::email('email',null,['placeholder' => 'Endereço de e-mail', 'required']) !!}
                                    <b class="tooltip tooltip-bottom-right">Use um e-mail válido.</b> </label>
                            </section>

                            <section>
                                <label class="input"> <i class="icon-append fa fa-lock"></i>
                                    {!! Form::password('senha',['required','placeholder' => 'Senha', 'required']) !!}
                                    <b class="tooltip tooltip-bottom-right">Não esqueça sua senha.</b> </label>
                            </section>

                            <section>
                                <label class="input"> <i class="icon-append fa fa-lock"></i>
                                    {!! Form::password('senha_confirm',['id' => 'password-confirm', 'placeholder' => 'Confirme a Senha', 'required']) !!}
                                    <b class="tooltip tooltip-bottom-right">Não esqueça sua senha.</b> </label>
                            </section>
                        </fieldset>
                        ...
                        <fieldset>
                            <div class="row">
                                <section class="col col-6">
                                    <label class="input">
                                        {!! Form::text('nome',null,['required','placeholder' => 'Primeiro nome', 'required']) !!}
                                    </label>
                                </section>
                                <section class="col col-6">
                                    <label class="input">
                                        {!! Form::text('sobrenome',null,['required','placeholder' => 'Último nome', 'required']) !!}
                                    </label>
                                </section>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <section class="col col-6">
                                    <label class="input"> <i class="icon-append fa fa-calendar"></i>
                                        {!! Form::text('nascimento',null,['class' => 'form-control calendar','required', 'required', 'placeholder' => 'Data de nascimento']) !!}
                                    </label>
                                </section>
                            </div>

        ...
        <div class="row">
            <div class="col-md-6 col-lg-offset-3">
                <div class="well no-padding">
                    ...
                    {!! Form::open(['route' => 'authUser.Rstore', 'method' => 'post', 'class' => 'smart-form client-form', 'id' => 'smart-form-register']) !!}
                        <header>
                        ...
                        <fieldset>
                            ...
                            <section>
                                <label class="input"> <i class="icon-append fa fa-user"></i>
                                    {!! Form::text('name',null,['required','placeholder' => 'Login', 'required']) !!}
                            ...
                            <section>
                                <label class="input"> <i class="icon-append fa fa-lock"></i>
                                    {!! Form::password('passwd',['required','placeholder' => 'Senha', 'required']) !!}
                                    <b class="tooltip tooltip-bottom-right">Não esqueça sua senha.</b> </label>
                            </section>

                            <section>
                                <label class="input"> <i class="icon-append fa fa-lock"></i>
                                    {!! Form::password('password_confirmation',['id' => 'password-confirm', 'placeholder' => 'Confirme a Senha', 'required']) !!}
                                    <b class="tooltip tooltip-bottom-right">Não esqueça sua senha.</b> </label>
                            </section>
                        </fieldset>
                        ...
                        <fieldset>
                            <div class="row">
                                <section class="col col-6">
                                    <label class="input">
                                        {!! Form::text('firstname',null,['required','placeholder' => 'Primeiro nome', 'required']) !!}
                                    </label>
                                </section>
                                <section class="col col-6">
                                    <label class="input">
                                        {!! Form::text('lastname',null,['required','placeholder' => 'Último nome', 'required']) !!}
                                    </label>
                                </section>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <section class="col col-6">
                                    <label class="input"> <i class="icon-append fa fa-calendar"></i>
                                        {!! Form::text('birthday',null,['class' => 'form-control calendar','required', 'required', 'placeholder' => 'Data de nascimento']) !!}
                                    </label>
                                </section>
                            </div>
